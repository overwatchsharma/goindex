    ...
    players() {
      return [
        ...
        },
        {
          ...
          scheme: `${this.copyVideoUrl}#intent;package=org.videolan.vlc;S.title=${this.title};end`,
        },
        {
          name: "Thunder",
        ...
        },
        {
          ...
          scheme: `${this.copyVideoUrl}#intent;package=com.mxtech.videoplayer.ad;S.title=${this.title};end`,
        },
        {
          name: "MXPlayer(Pro)",
          icon: this.$cdnpath("images/player/mxplayer.png"),
